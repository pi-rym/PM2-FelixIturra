(() => {
  ...
  var e = {
      425: (e, t, n) => {
        ...
        const v =
          ...
          T = (e) => !f(e) && e !== v,
          j =
            ((_ = "undefined" != typeof Uint8Array && s(Uint8Array)),
            (e) => _ && e instanceof _);
        var _;
        const N = c("HTMLFormElement"),
          ...
          B = "0123456789",
          U = { DIGIT: B, ALPHA: F, ALPHA_DIGIT: F + F.toUpperCase() + B },
          L = c("AsyncFunction");
        var D = {
          isArray: l,
          isArrayBuffer: d,
                ...
                return (
                  ...
                  a.forEach(function (e, r) {
                    !D.isUndefined(e) &&
                      null !== e &&
                      t.append(
                        !0 === i ? H([n], r, s) : null === i ? n : n + "[]",
                        c(e)
                      );
                  }),
                  !1
                );
            return !!z(e) || (t.append(H(o, n, s), c(e)), !1);
          }
          const l = [],
            f = Object.assign(J, {
              defaultVisitor: u,
        ...
        const _e = (e) => (e instanceof he ? { ...e } : e);
        function Ne(e, t) {
          t = t || {};
          const n = {};
          function r(e, t, n) {
        ...
        class Be {
          ...
          getUri(e) {
            return X(
              Ee((e = Ne(this.defaults, e)).baseURL, e.url),
              e.params,
              e.paramsSerializer
            );
          }
        ...
        (Ie.Axios = Ue),
          ...
          (Ie.mergeConfig = Ne),
          (Ie.AxiosHeaders = he),
          (Ie.formToJSON = (e) => se(D.isHTMLForm(e) ? new FormData(e) : e)),
          (Ie.getAdapter = ve),
  ...
  (n.g = (function () {
    ...
    (() => {
        ...
        Array.isArray(t)
          ? t.forEach((t) => {
              ...
              const r = `\n                <div class="card__front">\n                    <img src="${
                ...
                t.duration
              }</p>\n                    <p class="card__description">Género: ${t.genre.join(
                ", "
      ...
      const t = n(425),
        r = document.getElementById("estrenos-container"),
        o = document.getElementById("recomendados-container"),
        s = document.getElementById("tarjetas-container");
      t.get("http://localhost:3000/movies/")
        .then((t) => {
          const n = t.data;
          e(r, n), e(o, n), e(s, n);
        })
        .catch((e) => {
          console.error("Error al obtener datos de pelis:", e);
        });
    })();
})();
